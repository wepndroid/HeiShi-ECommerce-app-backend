...
STRIPE = '''"""Stripe Connect adapter — live Checkout Sessions via REST (PROG-408)."""
...
Path(__file__).resolve().parents[1].joinpath("app", "payments", "stripe_adapter.py").write_text(
    STRIPE, encoding="utf-8"
)
print("ok")
