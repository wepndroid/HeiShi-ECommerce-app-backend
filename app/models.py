...
class Order(Base):
    ...
    refund_reference: Mapped[str | None] = mapped_column(String(100), nullable=True, index=True)
    refund_failure_code: Mapped[str | None] = mapped_column(String(50), nullable=True)
    refund_failure_reason: Mapped[str | None] = mapped_column(Text, nullable=True)
